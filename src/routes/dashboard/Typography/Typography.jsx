        ...
        <div className="row">
          <div className="col-md-6 col-lg-8">
            ...
            <Panel header={<span>Wells</span>}>
              <Well bsSize="small" className="no-margin">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam perferendis
                molestias, quibusdam veritatis laborum eius ex. Quaerat harum voluptatibus
                recusandae consequatur? Id, repudiandae! Dolor blanditiis voluptate porro,
                perferendis voluptas, ad!
              </Well>
            </Panel>
            <Panel header={<span>Code</span>} bsStyle="warning">
              <p>
                This is an example of an inline code element within body copy. Wrap inline code
                within a <code>&lt;code&gt;...&lt;/code&gt;</code>tag.
              </p>
              <pre className="no-margin" >This is an example of preformatted text.</pre>
            </Panel>
          </div>
          <div className="col-lg-4 col-md-6">
            <Panel
              header={<span>Unordered Lists</span>}
              bsStyle="info"
            >
              <ul>
            ...
            <Panel
              header={<span>Ordered Lists</span>}
              bsStyle="warning"
            >
              <ol>
            ...
            <Panel
              header={<span>Unstyled List</span>}
              bsStyle="primary"
            >
            ...
            <Panel
              header={<span>Emphasis Classes</span>}
              bsStyle="info"
            >
            ...
            <Panel
              header={<span>Alignment Helpers</span>}
              bsStyle="primary"
            >
