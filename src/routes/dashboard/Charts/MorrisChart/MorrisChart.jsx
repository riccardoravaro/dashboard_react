    ...
    <div className="animate">
      <div className="row">
        <div className="col-lg-6">
          <Panel header={<span>Area Chart Example</span>} bsStyle="primary">
            <div>
        ...
        <div className="col-lg-6">
          <Panel header={<span>Bar Chart Example</span>} bsStyle="primary">
            <div>
              <ResponsiveContainer width="100%" aspect={2}>
        ...
        <div className="col-lg-6">
          <Panel header={<span>Line Chart Example</span>} bsStyle="primary">
            <div>
              <ResponsiveContainer width="100%" aspect={2}>
                <LineChart
                  layout="vertical"
        ...
        <div className="col-lg-6">
          <Panel header={<span>Donut Chart Example</span>} bsStyle="primary">
            <div>
